  ...
  return (
    <div>
      <div className='space-y-4'>
        ...
        <ul
          className='text-muted-foreground ml-2 list-inside list-disc space-y-3 text-sm'>
        ...
        <div className='flex flex-wrap items-center gap-4'>
          {/* vite */}
          <div
            className='flex items-center gap-1.5 rounded-[6px] bg-amber-600/10 px-3 py-1 dark:bg-amber-400/10'>
            <img
          ...
          {/* React */}
          <div
            className='flex items-center gap-1.5 rounded-[6px] bg-sky-600/10 px-3 py-1 dark:bg-sky-400/10'>
            <img
          ...
          {/* Angular */}
          <div
            className='bg-destructive/10 flex items-center gap-1.5 rounded-[6px] px-3 py-1'>
            <img
        ...
        <Accordion
          ...
          <AccordionItem value='item-1' className='bg-transparent'>
            <AccordionTrigger className='px-0 hover:no-underline [&>svg]:size-6!'>
              <Badge
                className='h-6 rounded-sm border-none bg-green-600/10 px-2 text-green-600 focus-visible:ring-green-600/20 focus-visible:outline-none dark:bg-green-400/10 dark:text-green-400 dark:focus-visible:ring-green-400/40 [a&]:hover:bg-green-600/5 dark:[a&]:hover:bg-green-400/5'>
                New
              </Badge>
            </AccordionTrigger>
          ...
          <AccordionItem value='item-2' className='bg-transparent'>
            <AccordionTrigger className='px-0 hover:no-underline [&>svg]:size-6!'>
              <Badge
                className='h-6 rounded-sm border-none bg-sky-600/10 px-2 text-sky-600 focus-visible:ring-sky-600/20 focus-visible:outline-none dark:bg-sky-400/10 dark:text-sky-400 dark:focus-visible:ring-sky-400/40 [a&]:hover:bg-sky-600/5 dark:[a&]:hover:bg-sky-400/5'>
                Updates
              </Badge>
            </AccordionTrigger>
            <AccordionContent className='text-muted-foreground'>
          ...
          <AccordionItem value='item-3' className='bg-transparent'>
            <AccordionTrigger className='px-0 hover:no-underline [&>svg]:size-6!'>
              <Badge
                className='h-6 rounded-sm border-none bg-amber-600/10 px-2 text-amber-600 focus-visible:ring-amber-600/20 focus-visible:outline-none dark:bg-orange-400/10 dark:text-orange-400 dark:focus-visible:ring-orange-400/40 [a&]:hover:bg-amber-600/5 dark:[a&]:hover:bg-orange-400/5'>
                Bug Fixes
              </Badge>
            </AccordionTrigger>
            <AccordionContent className='text-muted-foreground'>
