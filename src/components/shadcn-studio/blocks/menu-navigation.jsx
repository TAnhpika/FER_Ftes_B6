      ...
      <NavigationMenuList className='flex-wrap justify-start gap-1.5'>
        {navigationData.map(navItem => {
            ...
            return (
              <NavigationMenuItem key={navItem.title}>
                <NavigationMenuLink
                  ...
                  className={cn(
                    navigationMenuTriggerStyle(),
                    'text-muted-foreground hover:text-primary focus:text-primary dark:hover:bg-accent/50 bg-transparent px-3 py-1.5 text-base!'
                  )}>
                  {navItem.title}
                </NavigationMenuLink>
              </NavigationMenuItem>
          ...
          return (
            <NavigationMenuItem key={navItem.title}>
              <NavigationMenuTrigger
                className='dark:data-open:hover:bg-accent/50 text-muted-foreground hover:text-primary focus:text-primary dark:hover:bg-accent/50 bg-transparent px-3 py-1.5 text-base [&>svg]:size-4'>
                {navItem.title}
              </NavigationMenuTrigger>
              <NavigationMenuContent
