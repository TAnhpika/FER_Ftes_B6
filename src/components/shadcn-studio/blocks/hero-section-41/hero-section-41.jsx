      ...
      <div
          ...
          <div
            ...
            <div className='flex items-center gap-4'>
              ...
              <Button
                size='lg'
                asChild
                className='bg-primary/10 hover:bg-primary/20 [a]:hover:bg-primary/20 text-primary rounded-full'>
                <a href='#'>Book table</a>
              </Button>
            </div>
          </div>
        ...
        <div className='grid grid-cols-1 gap-24 gap-y-12 md:gap-y-16 lg:grid-cols-5'>
          <Carousel
            ...
            <div
              className='from-background pointer-events-none absolute inset-y-0 left-0 z-1 w-25 bg-linear-to-r via-85% to-transparent' />
            <div
              className='from-background pointer-events-none absolute inset-y-0 right-0 z-1 w-25 bg-linear-to-l via-85% to-transparent' />
